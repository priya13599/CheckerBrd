  ...
  <h1 align="center" style="color:red"><b><u>Customer Details</u></b></h1>
   ...
   <tbody>
      <tr onclick="myfunction(this)">
       ...
       <td> <a href="CheckerController?code=<%=customer.getCustomercode() %>&button=2"><input type="submit" name ="bt" value="Authorized"></a></td>
        <td><a href ="CheckerController?code=<%=customer.getCustomercode() %>&button=3"><input type="submit" name ="bt" value="Reject"></a></td>
