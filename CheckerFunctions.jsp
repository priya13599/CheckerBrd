...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="CheckerController?button=1" title="Data Authorization"><span class="glyphicon glyphicon-plus"></span> </a></li>
      <li><a href="CheckerController?button=4" title="Update Details"><span class="glyphicon glyphicon-edit"></span> </a></li>
