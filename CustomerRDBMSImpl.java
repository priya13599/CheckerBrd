...
ArrayList<Customer> arraylist = new ArrayList<Customer>();
	...
	public void SaveCustomerDetailsMST(Customer customer) throws SQLException {
			...
			PreparedStatement preparedstmt = con.prepareStatement("insert into makercheckercustomerMSTtable130 (customer_code,customer_name,customer_address1,customer_address2,customer_pin_code,email_address,contact_number ,primary_contact_person,record_status,active_inactive_flag,create_date,created_by,modified_date, modified_by,authorized_date,authorized_by) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			preparedstmt.setString(1,customer.getCustomercode());
			preparedstmt.setString(2, customer.getCustomername());
			preparedstmt.setString(3, customer.getAddress1());
			preparedstmt.setString(4, customer.getAddress2());
	...
	public void SaveRejectedCustomerDetails(Customer customer) throws SQLException {
		PreparedStatement preparedstmt = con.prepareStatement("update makercheckercustomertable130 set record_status=? where customer_code=?");
		preparedstmt.setString(2,customer.getCustomercode());
		
		preparedstmt.setString(1,"NR");
...
ArrayList<Customer> arraylist = new ArrayList<Customer>();
		...
		PreparedStatement preparedstmt = con.prepareStatement("select * from makercheckercustomertable130 where record_status=?");
